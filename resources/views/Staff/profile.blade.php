...
<body class="min-h-screen bg-gray-100 pb-24 font-sans text-gray-900 antialiased">
    ...
    <header
        class="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3 shadow-sm">
        <div>
        ...
        <a href="{{ route('staff.notification') }}" class="text-gray-500 hover:text-green-600">
