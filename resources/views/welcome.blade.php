...
<body class="min-h-screen bg-[#d8e6d8] font-[Instrument_Sans,_ui-sans-serif,_system-ui] text-[#243229]">
    <main class="mx-auto flex min-h-screen w-full max-w-4xl items-center justify-center px-4 py-8 sm:px-6">
        <section class="w-full max-w-[450px] text-center">
            <div
                class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-[#53b36a] shadow-[0_10px_25px_rgba(23,77,34,0.2)]">
            ...
            <div class="mt-10 space-y-4 text-left">
                <a href="{{ route('login', ['role' => 'student']) }}"
                    ...
                    <div class="flex items-start gap-4">
                        <span
                            class="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#5db56e] text-white">👤</span>
                        <span>
                            <span class="block text-2xl font-semibold text-[#223726]">Student</span>
                            <span class="mt-1 block text-sm text-[#4b6751]">Browse menu, order food and manage
                                wallet.</span>
                        </span>
                    </div>
                </a>
                ...
                <a href="{{ route('login', ['role' => 'staff']) }}"
                    ...
                    <div class="flex items-start gap-4">
                        <span
                            class="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#f0a623] text-white">✓</span>
                        <span>
            ...
            @if (Route::has('register'))
                <p class="mt-10 text-sm text-[#6f7e72]">
                    ...
                    <a href="{{ route('register') }}" class="font-semibold text-[#4aa160] hover:underline">Register
                        here</a>
                </p>
            @endif
        </section>
