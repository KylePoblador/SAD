...
<head>
    ...
    <title>Wallet Load Receipt — CoinMeal</title>
    ...
    <div class="coinmeal-container py-6 print:py-4">
        <div class="mx-auto max-w-md rounded-2xl border border-gray-200 bg-white p-6 shadow-sm print:border-0 print:shadow-none">
            <div class="text-center">
                ...
                <p class="mt-4 text-xs font-semibold uppercase tracking-wide text-gray-400">Wallet Load Receipt</p>
            </div>

            <div class="mt-6 space-y-1 text-sm">
                <div class="flex justify-between gap-4">
                    <span class="text-gray-500">Reference</span>
                    <span class="font-semibold text-gray-900">WL-{{ str_pad($log->id, 6, '0', STR_PAD_LEFT) }}</span>
                </div>
                <div class="flex justify-between gap-4">
                    <span class="text-gray-500">Date</span>
                    <span class="text-gray-900">{{ $log->created_at->format('M d, Y · g:i A') }}</span>
                </div>
                <div class="flex justify-between gap-4">
                ...
                <div class="flex justify-between gap-4">
                    ...
                    <span class="font-medium text-green-700">Credited ✓</span>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                <span class="text-base font-bold text-gray-800">Amount Loaded</span>
                <span class="text-xl font-bold text-green-600">₱{{ number_format((float) $log->amount, 2) }}</span>
            </div>

            <p class="mt-6 text-center text-[11px] leading-relaxed text-gray-400">
                Wallet was credited to <strong>{{ $canteenLabel }}</strong> account after cash payment at the counter.
            </p>
